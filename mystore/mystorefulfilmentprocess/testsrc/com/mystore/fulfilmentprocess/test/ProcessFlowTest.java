 ...
 *
 */
package com.mystore.fulfilmentprocess.test;
...
import com.mystore.fulfilmentprocess.test.actions.TestActionTemp;
...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/mystorefulfilmentprocess/test/mystorefulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/mystorefulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/mystorefulfilmentprocess/test/process/consignment-process-spring.xml"));
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/mystorefulfilmentprocess/test/mystorefulfilmentprocess-spring-testcleanup.xml"));
