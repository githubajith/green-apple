...
/**
 * Provides necessary meta information about the mystorecore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class MystoreCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MystoreCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.mystore.core.hmc.locales";
