 ...
 *
 */
package com.mystore.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("mystorecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("mystorecockpits.product.externalTaxes"));
